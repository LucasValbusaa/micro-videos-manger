...
class SecondStringValueObject extends ValueObject {
  constructor(readonly value: string) {
    super()
  }
}
...
describe('ValueObject Unit Test', () => {
  ...
  it('should not be equals', () => {
    ...
    const secondStringValueObject = new SecondStringValueObject('test')
    expect(valueObject1.equals(secondStringValueObject)).toBeFalsy()
  })
})
